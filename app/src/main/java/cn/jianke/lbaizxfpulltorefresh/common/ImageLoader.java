package cn.jianke.lbaizxfpulltorefresh.common;
...
public class ImageLoader {
     ...
     * @return
     */
    public void load(Context context, ImageView imageView, String url, Drawable defaultImage, Drawable errorImage){
        // 图片加载库采用Glide框架
